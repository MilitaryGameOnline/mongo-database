...
public class UnitInitiation {
	...
	public static Map<Integer, UnitType> makeUnitTypeMap1()
	{
		...
		damageValuesAssault_rifle.put(Fighter, 0.D);
		damageValuesAssault_rifle.put(Stealth_fighter, 0.D);
		damageValuesAssault_rifle.put(Bomber, 0.D);
		damageValuesAssault_rifle.put(Flying_bomb, 0.D);
		damageValuesAssault_rifle.put(Attack_helicopter, 0.D);
		damageValuesAssault_rifle.put(Support_helicopter, 0.D);
		damageValuesAssault_rifle.put(Transport_ship, 0.D);
		damageValuesAssault_rifle.put(Repair_ship, 0.D);
		damageValuesAssault_rifle.put(Submarine, 0.D);
		damageValuesAssault_rifle.put(Combat_ship, 0.D);
		damageValuesAssault_rifle.put(Cannon_ship, 0.D);
		damageValuesAssault_rifle.put(Aircraft_carrier, 0.D);
		...
		damageValuesBazooka.put(Fighter, 0.D);
		damageValuesBazooka.put(Stealth_fighter, 0.D);
		damageValuesBazooka.put(Bomber, 0.D);
		damageValuesBazooka.put(Flying_bomb, 0.D);
		damageValuesBazooka.put(Attack_helicopter, 0.D);
		damageValuesBazooka.put(Support_helicopter, 0.D);
		damageValuesBazooka.put(Transport_ship, 0.D);
		damageValuesBazooka.put(Repair_ship, 0.D);
		damageValuesBazooka.put(Submarine, 0.D);
		damageValuesBazooka.put(Combat_ship, 0.D);
		damageValuesBazooka.put(Cannon_ship, 0.D);
		damageValuesBazooka.put(Aircraft_carrier, 0.D);
...
//		unitTypes.put(Bike, bike);
		...
		damageValuesCar.put(Fighter, 0.D);
		damageValuesCar.put(Stealth_fighter, 0.D);
		damageValuesCar.put(Bomber, 0.D);
		damageValuesCar.put(Flying_bomb, 0.D);
		damageValuesCar.put(Attack_helicopter, 0.D);
		damageValuesCar.put(Support_helicopter, 0.D);
		damageValuesCar.put(Transport_ship, 0.D);
		damageValuesCar.put(Repair_ship, 0.D);
		damageValuesCar.put(Submarine, 0.D);
		damageValuesCar.put(Combat_ship, 0.D);
		damageValuesCar.put(Cannon_ship, 0.D);
		damageValuesCar.put(Aircraft_carrier, 0.D);
		...
		damageValuesSupplier.put(Assault_rifle, 0.D);
		damageValuesSupplier.put(Bazooka, 0.D);
		damageValuesSupplier.put(Bike, 0.D);
		damageValuesSupplier.put(Car, 0.D);
		damageValuesSupplier.put(Supplier, 0.D);
		damageValuesSupplier.put(Small_cannon, 0.D);
		damageValuesSupplier.put(Big_cannon, 0.D);
		damageValuesSupplier.put(Air_cannon, 0.D);
		damageValuesSupplier.put(Mobile_flak, 0.D);
		damageValuesSupplier.put(Small_tank, 0.D);
		damageValuesSupplier.put(Big_tank, 0.D);
		damageValuesSupplier.put(Super_tank, 0.D);
		damageValuesSupplier.put(Giant_tank, 0.D);
		damageValuesSupplier.put(Fighter, 0.D);
		damageValuesSupplier.put(Stealth_fighter, 0.D);
		damageValuesSupplier.put(Bomber, 0.D);
		damageValuesSupplier.put(Flying_bomb, 0.D);
		damageValuesSupplier.put(Attack_helicopter, 0.D);
		damageValuesSupplier.put(Support_helicopter, 0.D);
		damageValuesSupplier.put(Transport_ship, 0.D);
		damageValuesSupplier.put(Repair_ship, 0.D);
		damageValuesSupplier.put(Submarine, 0.D);
		damageValuesSupplier.put(Combat_ship, 0.D);
		damageValuesSupplier.put(Cannon_ship, 0.D);
		damageValuesSupplier.put(Aircraft_carrier, 0.D);
		...
		damageValuesSmall_cannon.put(Stealth_fighter, 0.D);
		damageValuesSmall_cannon.put(Bomber, 0.D);
		damageValuesSmall_cannon.put(Flying_bomb, 0.D);
		damageValuesSmall_cannon.put(Attack_helicopter, 0.D);
		damageValuesSmall_cannon.put(Support_helicopter, 0.D);
		...
		damageValuesBig_cannon.put(Fighter, 0.D);
		damageValuesBig_cannon.put(Stealth_fighter, 0.D);
		damageValuesBig_cannon.put(Bomber, 0.D);
		damageValuesBig_cannon.put(Flying_bomb, 0.D);
		damageValuesBig_cannon.put(Attack_helicopter, 0.D);
		damageValuesBig_cannon.put(Support_helicopter, 0.D);
		...
		damageValuesAir_cannon.put(Assault_rifle, 0.D);
		damageValuesAir_cannon.put(Bazooka, 0.D);
		damageValuesAir_cannon.put(Bike, 0.D);
		damageValuesAir_cannon.put(Car, 0.D);
		damageValuesAir_cannon.put(Supplier, 0.D);
		damageValuesAir_cannon.put(Small_cannon, 0.D);
		damageValuesAir_cannon.put(Big_cannon, 0.D);
		damageValuesAir_cannon.put(Air_cannon, 0.D);
		damageValuesAir_cannon.put(Mobile_flak, 0.D);
		damageValuesAir_cannon.put(Small_tank, 0.D);
		damageValuesAir_cannon.put(Big_tank, 0.D);
		damageValuesAir_cannon.put(Super_tank, 0.D);
		damageValuesAir_cannon.put(Giant_tank, 0.D);
		...
		damageValuesAir_cannon.put(Transport_ship, 0.D);
		damageValuesAir_cannon.put(Repair_ship, 0.D);
		damageValuesAir_cannon.put(Submarine, 0.D);
		damageValuesAir_cannon.put(Combat_ship, 0.D);
		damageValuesAir_cannon.put(Cannon_ship, 0.D);
		damageValuesAir_cannon.put(Aircraft_carrier, 0.D);
		...
		damageValuesMobile_flak.put(Transport_ship, 0.D);
		damageValuesMobile_flak.put(Repair_ship, 0.D);
		damageValuesMobile_flak.put(Submarine, 0.D);
		damageValuesMobile_flak.put(Combat_ship, 0.D);
		damageValuesMobile_flak.put(Cannon_ship, 0.D);
		damageValuesMobile_flak.put(Aircraft_carrier, 0.D);
		...
		damageValuesSmall_tank.put(Fighter, 0.D);
		damageValuesSmall_tank.put(Stealth_fighter, 0.D);
		damageValuesSmall_tank.put(Bomber, 0.D);
		damageValuesSmall_tank.put(Flying_bomb, 0.D);
		...
		damageValuesBig_tank.put(Fighter, 0.D);
		damageValuesBig_tank.put(Stealth_fighter, 0.D);
		damageValuesBig_tank.put(Bomber, 0.D);
		damageValuesBig_tank.put(Flying_bomb, 0.D);
		...
		damageValuesSuper_tank.put(Fighter, 0.D);
		damageValuesSuper_tank.put(Stealth_fighter, 0.D);
		damageValuesSuper_tank.put(Bomber, 0.D);
		damageValuesSuper_tank.put(Flying_bomb, 0.D);
		...
		damageValuesGiant_tank.put(Fighter, 0.D);
		damageValuesGiant_tank.put(Stealth_fighter, 0.D);
		damageValuesGiant_tank.put(Bomber, 0.D);
		damageValuesGiant_tank.put(Flying_bomb, 0.D);
		...
		damageValuesFighter.put(Assault_rifle, 0.D);
		damageValuesFighter.put(Bazooka, 0.D);
		damageValuesFighter.put(Bike, 0.D);
		damageValuesFighter.put(Car, 0.D);
		damageValuesFighter.put(Supplier, 0.D);
		damageValuesFighter.put(Small_cannon, 0.D);
		damageValuesFighter.put(Big_cannon, 0.D);
		damageValuesFighter.put(Air_cannon, 0.D);
		damageValuesFighter.put(Mobile_flak, 0.D);
		damageValuesFighter.put(Small_tank, 0.D);
		damageValuesFighter.put(Big_tank, 0.D);
		damageValuesFighter.put(Super_tank, 0.D);
		damageValuesFighter.put(Giant_tank, 0.D);
		...
		damageValuesFighter.put(Transport_ship, 0.D);
		damageValuesFighter.put(Repair_ship, 0.D);
		damageValuesFighter.put(Submarine, 0.D);
		damageValuesFighter.put(Combat_ship, 0.D);
		damageValuesFighter.put(Cannon_ship, 0.D);
		...
		damageValuesBomber.put(Fighter, 0.D);
		damageValuesBomber.put(Stealth_fighter, 0.D);
		damageValuesBomber.put(Bomber, 0.D);
		damageValuesBomber.put(Flying_bomb, 0.D);
		damageValuesBomber.put(Attack_helicopter, 0.D);
		damageValuesBomber.put(Support_helicopter, 0.D);
		...
		damageValuesFlying_bomb.put(Assault_rifle, 0.D);
		damageValuesFlying_bomb.put(Bazooka, 0.D);
		damageValuesFlying_bomb.put(Bike, 0.D);
		damageValuesFlying_bomb.put(Car, 0.D);
		damageValuesFlying_bomb.put(Supplier, 0.D);
		damageValuesFlying_bomb.put(Small_cannon, 0.D);
		damageValuesFlying_bomb.put(Big_cannon, 0.D);
		damageValuesFlying_bomb.put(Air_cannon, 0.D);
		damageValuesFlying_bomb.put(Mobile_flak, 0.D);
		damageValuesFlying_bomb.put(Small_tank, 0.D);
		damageValuesFlying_bomb.put(Big_tank, 0.D);
		damageValuesFlying_bomb.put(Super_tank, 0.D);
		damageValuesFlying_bomb.put(Giant_tank, 0.D);
		damageValuesFlying_bomb.put(Fighter, 0.D);
		damageValuesFlying_bomb.put(Stealth_fighter, 0.D);
		damageValuesFlying_bomb.put(Bomber, 0.D);
		damageValuesFlying_bomb.put(Flying_bomb, 0.D);
		damageValuesFlying_bomb.put(Attack_helicopter, 0.D);
		damageValuesFlying_bomb.put(Support_helicopter, 0.D);
		damageValuesFlying_bomb.put(Transport_ship, 0.D);
		damageValuesFlying_bomb.put(Repair_ship, 0.D);
		damageValuesFlying_bomb.put(Submarine, 0.D);
		damageValuesFlying_bomb.put(Combat_ship, 0.D);
		damageValuesFlying_bomb.put(Cannon_ship, 0.D);
		damageValuesFlying_bomb.put(Aircraft_carrier, 0.D);
