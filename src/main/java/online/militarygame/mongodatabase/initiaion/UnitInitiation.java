...
public class UnitInitiation {
	...
	public static Map<Integer, UnitType> makeUnitTypeMap1()
	{
		...
		secondaryDamageValuesBazooka.put(Assault_rifle, 0.D);
		secondaryDamageValuesBazooka.put(Bazooka, 0.D);
		secondaryDamageValuesBazooka.put(Bike, 0.D);
		secondaryDamageValuesBazooka.put(Car, 0.D);
		secondaryDamageValuesBazooka.put(Supplier, 0.D);
		secondaryDamageValuesBazooka.put(Small_cannon, 0.D);
		secondaryDamageValuesBazooka.put(Big_cannon, 0.D);
		secondaryDamageValuesBazooka.put(Air_cannon, 0.D);
		secondaryDamageValuesBazooka.put(Mobile_flak, 0.D);
		secondaryDamageValuesBazooka.put(Small_tank, 0.D);
		secondaryDamageValuesBazooka.put(Big_tank, 0.D);
		secondaryDamageValuesBazooka.put(Super_tank, 0.D);
		secondaryDamageValuesBazooka.put(Giant_tank, 0.D);
		secondaryDamageValuesBazooka.put(Attack_helicopter, 0.D);
		secondaryDamageValuesBazooka.put(Support_helicopter, 0.D);
...
//		unitTypes.put(Bike, bike);
		...
		secondaryValuesSmall_tank.put(Assault_rifle, 0.D);
		secondaryValuesSmall_tank.put(Bazooka, 0.D);
		secondaryValuesSmall_tank.put(Bike, 0.D);
		secondaryValuesSmall_tank.put(Car, 0.D);
		secondaryValuesSmall_tank.put(Supplier, 0.D);
		secondaryValuesSmall_tank.put(Small_cannon, 0.D);
		secondaryValuesSmall_tank.put(Big_cannon, 0.D);
		secondaryValuesSmall_tank.put(Air_cannon, 0.D);
		secondaryValuesSmall_tank.put(Mobile_flak, 0.D);
		secondaryValuesSmall_tank.put(Small_tank, 0.D);
		secondaryValuesSmall_tank.put(Big_tank, 0.D);
		secondaryValuesSmall_tank.put(Super_tank, 0.D);
		secondaryValuesSmall_tank.put(Giant_tank, 0.D);
		secondaryValuesSmall_tank.put(Attack_helicopter, 0.D);
		secondaryValuesSmall_tank.put(Support_helicopter, 0.D);
		...
		secondaryDamageValuesBig_tank.put(Assault_rifle, 0.D);
		secondaryDamageValuesBig_tank.put(Bazooka, 0.D);
		secondaryDamageValuesBig_tank.put(Bike, 0.D);
		secondaryDamageValuesBig_tank.put(Car, 0.D);
		secondaryDamageValuesBig_tank.put(Supplier, 0.D);
		secondaryDamageValuesBig_tank.put(Small_cannon, 0.D);
		secondaryDamageValuesBig_tank.put(Big_cannon, 0.D);
		secondaryDamageValuesBig_tank.put(Air_cannon, 0.D);
		secondaryDamageValuesBig_tank.put(Mobile_flak, 0.D);
		secondaryDamageValuesBig_tank.put(Small_tank, 0.D);
		secondaryDamageValuesBig_tank.put(Big_tank, 0.D);
		secondaryDamageValuesBig_tank.put(Super_tank, 0.D);
		secondaryDamageValuesBig_tank.put(Giant_tank, 0.D);
		secondaryDamageValuesBig_tank.put(Attack_helicopter, 0.D);
		secondaryDamageValuesBig_tank.put(Support_helicopter, 0.D);
